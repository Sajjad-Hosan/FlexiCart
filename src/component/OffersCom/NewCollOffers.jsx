  ...
  return (
    <div className="flex flex-col gap-5 mt-20">
      <div className="flex flex-col md:flex-row gap-5">
        <div className="card gap-4 border p-12 md:w-[40%] bg-gradient-to-r from-[#6F5D83] to-[#AF99C7]">
        ...
        <div className="card border p-12 md:w-[60%] bg-gradient-to-r from-[#EFEEFE] to-[#FAEFF5]">
      ...
      <div className="flex flex-col md:flex-row-reverse gap-5">
        <div className="card gap-4 border p-12 md:w-[40%] bg-gradient-to-r from-[#866657] to-[#D6A890]">
          <span className="badge badge-lg badge-neutral px-8 py-4 font-semibold">
            Up to 40%
          </span>
          <h1 className="text-2xl lg:text-4xl font-semibold">
