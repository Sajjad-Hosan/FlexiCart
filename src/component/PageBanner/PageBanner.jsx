...
const PageBanner = ({
  heading = "undefiend",
  afterPage = "undifirend",
  beforePage = "undefiend",
}) => {
  return (
    <div>
      <div className="card flex-col lg:flex-row justify-between border-b-2 mb-20">
        ...
        <img src={image} alt="" className="object-contain mt-10 lg:w-1/2 " />
      </div>
    </div>
  );
};
